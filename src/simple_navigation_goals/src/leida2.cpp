...
void laserCallback(const boost::shared_ptr<sensor_msgs::LaserScan>& scan) {
    ...
    for (int i = 0; i < num_ranges; ++i) {  
     ...
     // 检测边缘  
   for (int i = 110; i < 233; ++i) {  //110.35度到249.64度
...
int main(int argc, char** argv) {
    ...
    move_base_msgs::MoveBaseGoal goal[14];
    ...
    goal[3].target_pose.pose.position.x = 0.477;
    goal[3].target_pose.pose.position.y = -0.037;
    ...
    goal[3].target_pose.pose.orientation.z = 1.000;
    goal[3].target_pose.pose.orientation.w = 0.013; //过坡前的点

    goal[4].target_pose.pose.position.x = -1.950;
    goal[4].target_pose.pose.position.y = -0.015;
    ...
    goal[4].target_pose.pose.orientation.w = 0.004;  //过坡之后到的点

    goal[5].target_pose.pose.position.x = -2.353;
    goal[5].target_pose.pose.position.y = -1.670;
    ...
    goal[5].target_pose.pose.orientation.z = -0.715;
    goal[5].target_pose.pose.orientation.w = 0.699; //读取急救包位置

    goal[6].target_pose.pose.position.x = -1.852;
    goal[6].target_pose.pose.position.y = 0.004;
    ...
    goal[6].target_pose.pose.orientation.z = -0.003;
    goal[6].target_pose.pose.orientation.w = 1.000; //识别区域

    goal[7].target_pose.pose.position.x = -1.840;
    goal[7].target_pose.pose.position.y = 0.093;
    ...
    goal[7].target_pose.pose.orientation.z = -0.017;
    goal[7].target_pose.pose.orientation.w = 1.000; //坡道前停止区域

    goal[8].target_pose.pose.position.x = -0.003;
    goal[8].target_pose.pose.position.y = 0.049;
    ...
    goal[8].target_pose.pose.orientation.z = 0.000;
    goal[8].target_pose.pose.orientation.w = 1.000; //坡道后停止区域

    goal[9].target_pose.pose.position.x = 0.566;
    goal[9].target_pose.pose.position.y = 0.084;
    ...
    goal[9].target_pose.pose.orientation.z = -0.715;
    goal[9].target_pose.pose.orientation.w = 0.699; //进恐怖分子区域

    goal[10].target_pose.pose.position.x = 0.639;
    goal[10].target_pose.pose.position.y = -0.471;
    ...
    goal[10].target_pose.pose.orientation.z = 0.006;
    goal[10].target_pose.pose.orientation.w = 1.000; //第一个拐角

    goal[11].target_pose.pose.position.x = 1.512;
    goal[11].target_pose.pose.position.y = -0.442;
    ...
    goal[11].target_pose.pose.orientation.z = 0.716;
    goal[11].target_pose.pose.orientation.w = 0.698; //第二个拐角

    goal[12].target_pose.pose.position.x = 1.498;
    goal[12].target_pose.pose.position.y = 0.038;
    goal[12].target_pose.pose.position.z = 0.000;
    goal[12].target_pose.pose.orientation.x = 0.000;
    goal[12].target_pose.pose.orientation.y = 0.000;
    goal[12].target_pose.pose.orientation.z = 0.019;
    goal[12].target_pose.pose.orientation.w = 1.000; //出恐怖分子区域


    goal[13].target_pose.pose.position.x = 2.023;
    goal[13].target_pose.pose.position.y = -0.027;
    goal[13].target_pose.pose.position.z = 0.000;
    goal[13].target_pose.pose.orientation.x = 0.000;
    goal[13].target_pose.pose.orientation.y = 0.000;
    goal[13].target_pose.pose.orientation.z = 0.704;
    goal[13].target_pose.pose.orientation.w = 0.710; //到达终点

    point[0].target_pose.pose.position.x = -1.752;
    point[0].target_pose.pose.position.y = 0.886;
    point[0].target_pose.pose.position.z = 0.000;
    point[0].target_pose.pose.orientation.x = 0.000;
    point[0].target_pose.pose.orientation.y = 0.000;
    point[0].target_pose.pose.orientation.z = -0.316;
    point[0].target_pose.pose.orientation.w = 0.949; //识别右边区域

    point[1].target_pose.pose.position.x = -1.867;
    point[1].target_pose.pose.position.y = -0.975;
    point[1].target_pose.pose.position.z = 0.000;
    point[1].target_pose.pose.orientation.x = 0.000;
    point[1].target_pose.pose.orientation.y = 0.000;
    point[1].target_pose.pose.orientation.z = 0.379;
    point[1].target_pose.pose.orientation.w = 0.925; //识别左边区域
    ...
    for (i = 0; i < 14;i++) {
        ...
        if (i == 5 ) { 
            ...
            //     ros::spinOnce(); // 处理回调 
            // }  
            // sound_file = "~/ucar_car/src/simple_navigation_goals/voice/j0.wav";  
