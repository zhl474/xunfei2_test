...
public:
    QrProcessor():nh_("")
    {
        qrimage_sub_ = nh_.subscribe("/usb_cam/image_raw", 1, &QrProcessor::imageCallback, this);
        qr_server = nh_.advertiseService("qr_detect",&QrProcessor::qr_detect, this);
    }
...
private:
    ros::NodeHandle nh_; 
    ros::Subscriber qrimage_sub_;
    sensor_msgs::ImageConstPtr latest_img_;  // 智能指针成员变量
    ros::ServiceServer qr_server;
